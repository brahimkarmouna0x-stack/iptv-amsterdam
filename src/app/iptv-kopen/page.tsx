...
import { IptvKopenChecklist, IptvKopenFaq } from "@/components/sections/page/IptvKopenSections";
import AuthoritySections from "@/components/sections/page/AuthoritySections";

const content = SIXTEEN_SECTION_PAGES["iptv-kopen"];
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbSchema([
            ...
            { name: "IPTV Kopen", url: absoluteUrl("/iptv-kopen") },
          ])),
        }}
      />
      <script
      ...
      <SixteenSectionLayout
        ...
        extraSections={
          <>
            <AuthoritySections slug="iptv-kopen" />
            <IptvKopenChecklist />
            <IptvKopenFaq />
            <Stats />
            <ChannelShowcase />
